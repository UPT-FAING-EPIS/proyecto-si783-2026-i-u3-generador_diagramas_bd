  ...
  const steps = [
    {
      ...
      desc: "Usa Claude, Cursor o GPT. FluxSQL actúa como puente local seguro mediante el protocolo MCP (Model Context Protocol)."
    },
    {
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            FluxSQL soluciona el riesgo de usar agentes IA directamente. Validamos, aislamos y auditamos cada consulta.
          </p>
        </div>
