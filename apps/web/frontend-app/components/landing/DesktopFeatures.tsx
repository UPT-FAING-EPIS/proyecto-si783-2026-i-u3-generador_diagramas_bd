        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-slate-600 mb-8">
              La arquitectura Sidecar de Fluxy (FastAPI + Tauri + SQLite) está diseñada para potenciar tu trabajo con IA sin comprometer la seguridad empresarial.
            </p>
              ...
              <div className="relative z-10 w-full max-w-sm">
                <div className="bg-slate-900 text-white rounded-2xl p-4 shadow-lg mb-4 transform -rotate-2">
                  ...
                  <div className="font-mono text-sm text-blue-400">
                    <span className="text-pink-400">fluxy</span> mcp start --sandbox
                  </div>
